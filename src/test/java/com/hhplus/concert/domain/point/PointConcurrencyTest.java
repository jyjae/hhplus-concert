...
//    @DisplayName("포인트 충전 동시성 테스트 성공 - 비관적 락")
//    @Sql({"/reset.sql", "/insert.sql"})
//    @Test
//    public void shouldCompleteChargePointWithPessimisticLockWithConcurrencySuccessfully() throws InterruptedException {
//        int threadCount = 100; // 동시에 실행할 스레드 수
//        ExecutorService executorService = Executors.newFixedThreadPool(threadCount);
//        CountDownLatch latch = new CountDownLatch(threadCount);
//        AtomicInteger successCount = new AtomicInteger(0);
...
//
//        assertThat(successCount.get()).isEqualTo(1);
//        assertThat(retryCount.get()).isGreaterThanOrEqualTo(99);
//    }
